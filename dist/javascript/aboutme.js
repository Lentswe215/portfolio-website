function renderAboutMe() {
  let result = `
    <div id="about" class="page" data-jquery-page-name="aboutPage">
		...
		<div class="top-section">
			...
			<div class="about-text">
				<p class="anim">
					...
					willing to relocating if I need to.I enjoy building interactive and responsive web apps on both
					front-end and back-end. Always looking forward to working and learning new technologies.
				</p>
			</div>
		</div>
